...
// Two different roots since the workspace split: `.env` belongs to this app, the migrations
// belong to the repo — `supabase/` is shared infrastructure and deliberately stays above
// `apps/`. See docs/2026-08-09-expo-repo-structure-migration.md §3.
